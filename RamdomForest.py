...
x = merged_df[['scaled_screen_time', 'screen_time_x_gender', 'screen_time_x_minority', 'screen_time_x_deprived', 
               'gender', 'scaled_computer_time', 'scaled_game_time', 
...
# Initializing and fitting the Random Forest Regressor model with optimizations
rf = RandomForestRegressor(n_estimators=50, max_depth=10, max_features='sqrt', random_state=42)
